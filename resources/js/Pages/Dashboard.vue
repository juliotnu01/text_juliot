...
const { StoreEmployee, clearFilter, cancelUpdateEmployee, UpdateEmployee, importEmployee, handleFile, generatePdfHistoryEmployee } = employeeStore;
                    ...
                    <DialogModal :show="openModalHistoryEmployee" closeable>
                        ...
                        <template #footer>
                            <div class="flex gap-2">
                                ...
                                <button @click="generatePdfHistoryEmployee(employee)"
                                    class="flex items-center px-4 py-2 text-white bg-gray-500 hover:bg-gray-600 rounded gap-2">
                                    <svg fill="currentColor" width="20px" height="20px" viewBox="0 0 1920 1920"
